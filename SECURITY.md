...
Report vulnerabilities in this StartOS package using [GitHub private vulnerability reporting](https://github.com/remcoros/am-i-exposed-startos/security/advisories/new).

For bugs with no security or privacy impact, open a [regular GitHub issue](https://github.com/remcoros/am-i-exposed-startos/issues/new/choose).
