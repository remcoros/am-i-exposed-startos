...
const dict = {
  ...
  Mainnet: 11,
  Testnet4: 12,
  'Choose the Bitcoin network and service log level.': 13,
  ...
  'Log level': 18,
  'Control embedded proxy and Web UI nginx log verbosity. Informational and more verbose levels include HTTP request logs.': 19,
  'Errors only': 20,
