...
1. Open **Actions → Configure**, select **Mainnet** or **Testnet4**, and choose
   the service log level. Testnet4 and **Warnings and errors** are the defaults.
...
large-wallet analysis. The service log level controls both the embedded proxy
and Web UI nginx. Its default **Warnings and errors** setting suppresses their
...
Backups retain the Web UI data, selected network, and service log level. The
